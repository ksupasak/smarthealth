...
class BluetoothOffScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Color.fromARGB(255, 70, 180, 170)),
              ...
              child: Column(
                ...
                children: [
                  FloatingActionButton(
                      backgroundColor: Color.fromARGB(255, 70, 180, 170),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            //8888888888888
            // StreamBuilder(
            //   stream: bluetoothDataStream, // Stream ของค่าที่อุปกรณ์ส่งมา
            //   builder: (BuildContext context, AsyncSnapshot snapshot) {
            //     if (snapshot.hasData) {
            //       // นำค่าจาก Stream มาแสดงผลหรือประมวลผลต่อได้
            //       return Text("Received data: ${snapshot.data}");
            //     } else {
            //       // กรณีไม่มีค่าจาก Stream
